    ...
    <v-container class="pa-0">
        <v-layout wrap align-center justify-center row fill-height >
           <v-flex xs12 sm5 md3 lg3 xl3 class="text-xs-center pa-3">
                <v-img
                    :src="require('@/assets/img/gdgsan.jpg')"
                    :lazy-src="require('@/assets/img/gdgsan.jpg')"
                    width="100%">
                    <v-layout
                        slot="placeholder"
                        fill-height
            ...
            <v-flex xs12 sm7 md8 lg8 xl8 class="">
                <p class="google-font mb-1" style="font-weight: 350;color: #616161;font-size:300%"><b>Hagamos buenas cosas 
                ...
                <v-btn :href="chapterDetails.GDGProgramWebsite" target="_blank" round color="cyan" style="text-transform: capitalize;border-radius:5px;text-transform: capitalize;" outline  class="ml-0" dark>Saber más</v-btn>
